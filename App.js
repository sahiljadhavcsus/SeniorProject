...
export default function App() {
  ...
  async function retrieveUserSession() {
    ...
    if (result) {
      ...
      // if (valid) {
        // setUserToken(result);
        setUserToken("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NDViMjljNTI1NWVlMjAxZDRlYTMzMTgiLCJpYXQiOjE2ODM2OTgwNjYsImV4cCI6MTY4Mzc4NDQ2Nn0.-Ag_bs82GGkU-HBVz1Em-OKo7QpQJDr7WCjr0oxlSac");
        setLoginState(true);
      // } else {
